...
_HERMES_CORE_TOOLS = [
    ...
    "computer_use",
    # 社交媒体采集工具集 (gated on sd_mcp directory existing via check_fn)
    "sd_list_accounts", "sd_check_task", "sd_browser_launch_windows",
    "sd_open_url", "sd_cdp_login",
    "sd_ins_collect_fans", "sd_ins_fans_location", "sd_ins_fans_full",
    "sd_ins_collect_posts", "sd_ins_collect_comments", "sd_ins_posts_full",
    "sd_ins_send_dm", "sd_db_manager",
]
...
TOOLSETS = {
    ...
    "sd_mcp": {
        "description": (
            "浏览器窗口管理与账号登录工具集：启动防检测浏览器、"
            "打开网址、Instagram/Facebook 接口级登录（GraphQL + 密码加密）。"
        ),
        "tools": [
            "sd_list_accounts", "sd_check_task", "sd_browser_launch_windows",
            "sd_open_url", "sd_cdp_login",
